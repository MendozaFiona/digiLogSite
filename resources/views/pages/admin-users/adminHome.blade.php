                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="card container text-center" style= "background-color: #191851; border-radius: 20px;" >
                            ...
                            <div class="pt-1 pb-5 card-body">
                                ...
                                <div class="pt-4">
                                    <a href="{{url('/viewAllVisits?date=').$this_date}}" class="btn btn-secondary btn-lg btn-block" style = "background-color: #FDB417; border-radius: 20px; font-size: 18px;">All Visit</a>
                                </div>
                            </div>
